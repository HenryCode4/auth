...
const Dashboard = () => {
    ...
    return ( 
        ...
        <div className=" container space-y-6 text-center">
            ...
            <h1 className=" text-6xl p-2 font-bold bg-gradient-to-l from-[#17C8DA] via-[#7bf143] to-[#e07832] bg-clip-text text-transparent">Unlike any company you hired before</h1>
